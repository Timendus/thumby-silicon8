...
initFile = '/Games/Silicon8/Silicon8.py'
...
# For some reason this code (taken from menu.py) doesn't seem to work from
# the REPL over AMPY...
#
# def startProgram(file):
#     # Update config file to start this game
